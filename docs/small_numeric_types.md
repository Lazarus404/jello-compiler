...
Jello supports narrow numeric types **I8**, **I16**, and **F16** alongside the standard I32, I64, F32, and F64. These types enable smaller constants and reduced register pressure while keeping the VM and compiler simple.
